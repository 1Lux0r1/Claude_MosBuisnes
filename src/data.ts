...
export interface Partner {
  ...
  url: string;
  /** Если задано — карточка не открывает детальную шторку, а ведёт на страницу
      каталога «Услуги», отфильтрованную по этой категории (напр. «Все
...
/* Дополнительные бизнес-направления фильтра «Направление» — сверх категорий
   каталога. Показываются в фильтре в этом порядке после категорий. */
export const EXTRA_DIRECTIONS: string[] = [
  "Торговля",
  "Промышленность",
  "Наука, IT, Производство",
  "ЖКХ и природопользование",
  "Налогообложение и финансы",
  "Транспорт",
  "Торговля, реклама и общепит",
  "Имущество",
];

/* Привязка существующих услуг к бизнес-направлениям по смыслу (поверх category,
   без выдумывания новых услуг). Ключ — id услуги. Направление без услуг видно в
   фильтре, но даёт пустой список. Сейчас без услуг: «ЖКХ и природопользование». */
export const SERVICE_DIRECTIONS: Record<string, string[]> = {
  s1: ["Торговля", "Торговля, реклама и общепит"],
  s2: ["Имущество"],
  s3: ["Промышленность", "Наука, IT, Производство"],
  s5: ["Имущество"],
  s6: ["Имущество"],
  s7: ["Налогообложение и финансы"],
  s8: ["Наука, IT, Производство"],
  s9: ["Транспорт"],
  s10: ["Транспорт"],
  s11: ["Транспорт", "Торговля"],
  s12: ["Транспорт"],
  s13: ["Транспорт"],
  s14: ["Транспорт"],
  c1: ["Налогообложение и финансы"],
  c3: ["Торговля, реклама и общепит"],
  c4: ["Наука, IT, Производство"],
};
export const serviceDirections = (id: string): string[] => SERVICE_DIRECTIONS[id] ?? [];
...
export const PARTNER_PAGES: { label: string; items: Partner[] }[] = [
  ...
  },
  {
    label: "Госсервисы",
    items: [
      /* Тексты benefit/unique/details — заглушки под реальный контент госсервисов,
         подлежат уточнению. Конкретные суммы/проценты намеренно не выдуманы. */
      {
        id: "fns", name: "ФНС России", logo: "ФНС", logoBg: "#0e1220", logoFg: "#ffffff",
        artFrom: "#3a4a6b", artTo: "#141b2c", artIcon: "receipt",
        desc: "Личный кабинет налогоплательщика: отчётность, сверки и уплата налогов онлайн.",
        badge: "Налоги онлайн",
        benefit: "Сдача отчётности и уплата налогов без визита в инспекцию",
        unique: "Официальный сервис Федеральной налоговой службы",
        details: [
          "Личный кабинет юрлица и ИП",
          "Сверка расчётов с бюджетом",
          "Уплата налогов и госпошлин онлайн",
          "Запрос справок и выписок",
        ],
        url: "https://www.nalog.gov.ru",
      },
      {
        id: "moex", name: "Московская Биржа", logo: "МБ", logoBg: "#e6efff", logoFg: "#0a52c9",
        artFrom: "#2f8cff", artTo: "#0a52c9", artIcon: "trend-up",
        desc: "Биржевые торги валютой, ценными бумагами и инструментами денежного рынка.",
        badge: "Биржевой рынок",
        benefit: "Доступ к организованным торгам для бизнеса",
        unique: "Крупнейшая биржевая площадка России",
        details: [
          "Валютный рынок",
          "Фондовый рынок",
          "Денежный рынок",
          "Доступ через брокеров — участников торгов",
        ],
  ...
  },
  {
    ...
    items: [
      ...
      {
        /* Плашка-вход в каталог коммерческих сервисов (бывш. Ozon). По клику не
           открывает детальную шторку, а ведёт на страницу «Услуги» с категорией
           «Коммерческие сервисы» (см. servicesCategory). */
        id: "comm-services", name: "Все коммерческие сервисы", logo: "КС", logoBg: "#e6efff", logoFg: "#0a52c9",
        artFrom: "#4f9dff", artTo: "#0a52c9", artIcon: "spark",
        servicesCategory: "Коммерческие сервисы",
        desc: "Бухгалтерия, юристы, реклама и IT-подряд для бизнеса.",
        badge: "Открыть каталог",
        benefit: "Каталог коммерческих сервисов для бизнеса в одном месте",
        unique: "Проверенные партнёры для рутинных задач бизнеса",
        details: [
          "Бухгалтерское обслуживание",
          "Юридическое сопровождение",
          "Реклама и продвижение",
          "Разработка и IT-подряд",
        ],
